    ...
    <>
      <div className="custom-dropdown">
        <select
          ...
          style={props.selectClass ? props.selectClass : null}
          id="customDropdown"
          value={selectedOption}
          onChange={(event) => onItemChange(event)}
        >
          <option
            style={props.optionClass ? props.optionClass : null}
          ...
          {props.items.map((item) => {
            return (
              <option
                value={props.optionValue ? item[props.optionValue] : item}
              >
